...
export function jalaliDateTimeToGeorgianDateTime(faDateTime) {
  ...
  return moment(faDateTime, "jYYYY/jMM/jDDTHH:mm").format(
    "YYYY-MM-DDTHH:mm:ss",
  );
}
...
export const isDateAfterDate = (
  date,
  comparedDate = getCurrentJalaliDateTime(),
) => {
  const isAfter = moment(date, "jYYYY/jMM/jDDTHH:mm").isAfter(
    moment(comparedDate, "jYYYY/jMM/jDDTHH:mm"),
  );
  return isAfter;
};
