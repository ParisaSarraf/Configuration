...
import {useDeleteReasonsEditing, useReasonsEditingList,} from "@/QueryServises/ReasonsEditingQuery/index.js";
...
const ReasonsEditing = () => {
    ...
    const {isPending: isDeleting, mutateAsync: deleteReasonsEditing} = useDeleteReasonsEditing();
