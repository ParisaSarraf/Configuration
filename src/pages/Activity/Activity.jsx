...
const Activity = () => {
 ...
 const { isLoading: isExporting, refetch: exportRefetch } =
 useExportExcelActivity(currentProduct?.id, {
 enabled: false,
 });
 ...
 refetch,
 isLoading,
 } = useGetProductActivitiesType(productId || currentProduct?.id, filters);
 ...
 handleDownload(
 result.data,
 `_فعالیت‌های_${currentProduct.name || currentProduct.id}.csv`
 );
 ...
 <Button
 title={"خروجی اکسل"}
 className={"text-emerald-500 border-emerald-500 mt-2"}
