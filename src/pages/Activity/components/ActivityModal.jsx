        ...
        <Row gutter={16}>
            ...
            <>
              <Col span={activityType === "meeting" ? "12" : "24"}>
                <Form.Item name="type" label="نوع">
                  <Select>
                    <Select.Option value="meeting">صورتجلسه</Select.Option>
          ...
          <Col span={12}>
            <Form.Item label={"متولی انجام"} name="trustee_id">
              <Select
                options={usersData?.map((user, index) => {
                  return {
                    value: user.id,
            ...
            <Form.Item label={"جهت "} name={"referral_order"}>
              <Select
                options={[
                  ...
                  {
                    value: "For communicate the program",
                    label: "جهت ابلاغ برنامه",
                  },

                  {
                    value: "For immediate action",
                    label: "جهت اقدام فوری",
                  },
                ]}
              />
            </Form.Item>
