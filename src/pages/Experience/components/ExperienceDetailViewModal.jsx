...
const ExperienceDetailViewModal = ({
 ...
 <div>
 <span className="font-medium text-slate-600">عنوان حوزه:</span>
 <p className="mt-1">{precinct?.title || '---'}</p>
 </div>
 <div>
 <span className="font-medium text-slate-600">تاریخ ثبت:</span>
 ...
 <div className="space-y-3">
 <div>
 <span className="font-medium text-slate-600">نام و نام خانوادگی:</span>
