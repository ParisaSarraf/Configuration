...
const GoodsCategories = () => {
 ...
 <div className="absolute bottom-0 right-0 w-40 h-40 bg-blue-500 rounded-full blur-[80px] opacity-20"></div>
 ...
 <span
 key={role.id}
 className="bg-gradient-to-r from-blue-600 to-blue-600 text-white px-4 py-1.5 rounded-lg text-sm font-medium shadow-lg shadow-blue-900/20"
 >
 {role.name}
 </span>
 ))}
