...
export const FIELD_DEFS = [
  {
    type: "text",
    label: "متن تک‌خطی",
    hint: "یک کادر ورودی ساده",
    group: "ورودی متن",
    panels: ["basic", "length", "regex"],
  },
  {
    type: "textarea",
    label: "متن چندخطی",
    hint: "کادر بزرگ چندخطی",
    group: "ورودی متن",
    panels: ["basic", "length"],
  },
  {
  ...
  },
  {
    type: "address",
    label: "نشانی",
    hint: "نشانی چندخطی همراه کدپستی",
    group: "ورودی متن",
    panels: ["basic"],
  },
...

  {
    ...
    label: "لیست کشویی",
    group: "انتخاب",
    panels: ["basic", "choices"],
  },
  {
    type: "radio",
    label: "تک‌انتخابی (رادیویی)",
    group: "انتخاب",
    panels: ["basic", "choices"],
  },
  {
    type: "option_row",
    label: "گزینه‌های خطی",
    hint: "رادیویی در یک خط — مخصوص فرم چاپی",
    group: "انتخاب",
    panels: ["help", "choices"],
    backend: "radio",
    marker: "opt-inline",
  ...
  {
    type: "checkbox",
    label: "تیک تکی (بله/خیر)",
    group: "انتخاب",
    panels: ["help", "checkboxLabel"],
  },
  {
    type: "checkboxes",
    label: "چند تیک",
  ...
  {
    type: "multiselect",
    label: "چندانتخابی (تیک‌دار)",
    group: "انتخاب",
    panels: ["help", "choices"],
  },
  {
    type: "multiselect_list",
    label: "چندانتخابی (لیستی)",
    group: "انتخاب",
    panels: ["basic", "choices"],
  },
...

  {
    type: "matrix",
    label: "جدول پرشدنی",
    hint: "ستون‌ها را شما می‌سازید، کاربر ردیف اضافه می‌کند",
    group: "جدول",
    panels: ["help", "matrix"],
  },
  {
  ...
  { type: "signature", label: "محل امضا", group: "سند", panels: ["help"] },
  {
    type: "date_signature",
    label: "تاریخ و امضا",
    hint: "خانهٔ تاریخ + محل امضا در یک ردیف؛ برچسب خانه‌ها در بخش گزینه‌ها قابل تغییر است",
    group: "سند",
    panels: ["help", "choices"],
    backend: "signature",
    marker: "el-datesign",
  },
  {
    type: "logo",
    label: "لوگو",
    hint: "تصویر لوگو با نشانی دلخواه",
    group: "سند",
    panels: ["staticText"],
  ...
  },
  {
    type: "form_number",
    label: "شماره فرم",
    hint: "کد یا شمارهٔ سند — عنوان و مقدارش قابل تغییر است",
    group: "سند",
    panels: ["staticText"],
    backend: "display_text",
    marker: "el-formno",
  },
  {
    type: "section",
    label: "عنوان بخش",
    hint: "نوار تیتر — در submission ذخیره نمی‌شود",
    group: "سند",
    panels: [],
  },
  {
