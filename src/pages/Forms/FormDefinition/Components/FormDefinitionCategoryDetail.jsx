...
const SectionLabel = ({ children }) => (
 ...
 <span className="h-3 w-[3px] rounded-full bg-[#D97706]" />
...
const LeaderRow = ({ icon, label, value }) => (
 ...
 <span
 className="shrink-0 text-sm font-bold text-slate-800"
...
const FormDefinitionCategoryDetail = ({
 ...
 style={{
 background:
 "linear-gradient(135deg, #172033 0%, #2447D8 100%)",
 }}
 >
 ...
 <div className="mb-1.5 flex items-center gap-1.5 text-xs font-medium tracking-wide text-blue-200/70">
 <FileTextOutlined />
 ...
 {form.description && (
 <p className="mt-1.5 line-clamp-2 text-sm leading-relaxed text-blue-100/70">
 {form.description}
 </p>
 )}
 </div>
 ...
 style={{
 background:
 "linear-gradient(90deg, transparent, #D97706 15%, #D97706 85%, transparent)",
 }}
 />
 {/* approval stamp */}
 ...
 <div
 className="flex items-center justify-between border-b border-dashed border-slate-200 bg-slate-50/70 px-5 py-2.5 pt-9 text-xs text-slate-400"
 style={{ fontVariantNumeric: "tabular-nums" }}
 >
 <span>
 شماره سند:{" "}
 ...
 <Tag
 key={g.id}
 className="!rounded-full !border-[#172033]/20 !bg-[#172033]/5 !text-[#172033]"
 >
 {g.name}
 </Tag>
 ))
 ...
 {/* footer note */}
 <div className="mt-1 border-t border-dashed border-slate-200 pt-3 text-center text-xs text-slate-300">
