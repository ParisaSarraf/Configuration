...
const FormDefinitionCols = ({
 ...
 <span className="inline-flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-br from-blue-50 to-blue-100 text-xs font-bold text-blue-600">
 {index + 1}
 </span>
 ),
 },
 ...
 type="text"
 icon={<DeleteOutlined />}
 className={`${actionClass} !bg-red-50 !text-red-500 hover:!bg-red-100`}
 ...
 type="text"
 icon={<EyeOutlined />}
 className={`${actionClass} !bg-blue-50 !text-blue-600 hover:!bg-blue-100`}
