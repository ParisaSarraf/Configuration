...
const CategoryMain = ({
 ...
 <aside className="min-h-0 overflow-hidden rounded-2xl border border-blue-100 bg-white shadow-md shadow-blue-100/60">
 <div className="flex items-center gap-2 border-b border-blue-100 bg-gradient-to-l from-blue-50 to-blue-50 px-4 py-3">
 ...
 {/* Main — لیست فرم‌ها */}
 <main className="flex min-h-0 flex-col overflow-hidden rounded-2xl border border-blue-100 bg-white shadow-md shadow-blue-100/60">
 <div className="flex shrink-0 items-center justify-between gap-3 border-b border-blue-100 bg-gradient-to-l from-blue-50 via-blue-50 to-white px-5 py-3">
 <div className="flex items-center gap-2">
 <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-blue-500/10 text-blue-600">
 <FileSpreadsheet size={16} />
 </span>
 <div>
 <h2 className="m-0 text-sm font-bold text-blue-900">
 {activeCategoryName}
 </h2>
 <p className="m-0 text-xs text-blue-400">
 ...
 <div className="flex h-full flex-col items-center justify-center gap-3 rounded-xl border border-dashed border-blue-200 bg-blue-50/40 p-8 text-center">
 <span className="flex h-14 w-14 items-center justify-center rounded-2xl bg-white text-blue-500 shadow-sm">
 <Inbox size={26} />
 </span>
 ...
 <div className="flex shrink-0 items-center gap-2 border-b border-emerald-100 bg-gradient-to-l from-emerald-50 to-blue-50 px-4 py-3">
