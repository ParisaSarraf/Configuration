...
const CategoryHeader = ({ refetch, totalCategories = 0, totalForms = 0 }) => {
 ...
 return (
 <header className="relative mb-6 overflow-hidden rounded-2xl border border-white/40 bg-gradient-to-l from-blue-600 via-blue-600 to-blue-600 px-6 py-5 shadow-lg shadow-blue-200/60">
 ...
 <FolderTree size={16} className="text-blue-200" />
 <span className="text-xs text-white/80">دسته‌بندی‌ها</span>
 ...
 <span className="text-xs text-white/80">فرم‌ها</span>
 <span className="rounded-lg bg-white/25 px-2 py-0.5 text-xs font-bold">
 {totalForms}
 </span>
 </div>
 ...
 onClick={() => navigate("/")}
 className="!flex !h-10 !items-center !rounded-xl !bg-white !px-4 !font-semibold !text-blue-700 shadow-sm hover:!bg-blue-50 hover:!text-blue-800"
 >
 بازگشت به صفحه اصلی
 </Button>
 </div>
