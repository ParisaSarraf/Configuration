...
const processRequestColumns = ({ page = 1, pageSize = 8, onView, onReferral }) => [
 ...
 <span className="inline-flex h-8 w-8 items-center justify-center rounded-xl bg-slate-100 text-xs font-black text-slate-600 ">
 ...
 return (
 <div className="rounded-2xl border border-slate-200 bg-gradient-to-l from-slate-50 to-white p-3 shadow-sm ">
 ...
 return (
 <div className="flex max-w-[260px] flex-col gap-1 rounded-xl bg-slate-50 p-2 ">
 ...
 type="primary"
 size="small"
 className="!border-none !bg-gradient-to-l !from-blue-600 !to-blue-500 !font-bold shadow-md shadow-blue-500/20 hover:!from-blue-700 hover:!to-blue-600"
 icon={<SendOutlined />}
