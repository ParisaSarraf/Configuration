...
const ProcessMakerCartable = () => {
 ...
 onClick={() => navigate(-1)}
 className="mb-4 flex items-center text-slate-600 hover:!text-blue-600 "
 >
 بازگشت به صفحه قبل
 </Button>

 {/* ---------- هدر ---------- */}
 <div className="overflow-hidden rounded-2xl bg-gradient-to-l from-blue-500 to-blue-600 p-5 shadow-sm sm:p-7">
