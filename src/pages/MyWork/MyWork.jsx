...
const MyWork = () => {
 ...
 activeClass: "bg-blue-200 text-blue-800 shadow-md",
 inactiveClass: "text-blue-700 hover:bg-blue-100",
 },
 {
 ...
 children: <Waiting />,
 activeClass: "bg-red-200 text-red-800 shadow-md",
 inactiveClass: "text-red-700 hover:bg-red-100",
 },
 {
 label: "کارهای من",
 key: "3",
 ...
 کارتابل <span className="text-blue-600">{userName}</span>
 </h1>
