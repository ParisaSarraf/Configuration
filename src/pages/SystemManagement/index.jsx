...
const managementItems = [
 ...
 icon: <TeamOutlined className="text-2xl text-red-600" />,
 },
 {
 ...
 description: "مدیریت محصولات در درختواره محصولات.",
 icon: <ProductOutlined className="text-2xl text-blue-600" />,
 },
];
...
const ManagementCard = ({ item }) => (
 <NavLink
 to={item.path}
 className="group flex flex-col justify-between bg-white p-6 rounded-xl border border-slate-200 shadow-sm hover:shadow-xl hover:border-blue-500 transition-all duration-300 transform hover:-translate-y-1"
 >
 <div>
 <div className="mb-4">
 <div className="w-12 h-12 flex items-center justify-center rounded-lg bg-slate-100 group-hover:bg-blue-100 transition-colors duration-300">
 {item.icon}
 </div>
 </div>
 ...
 <div className="mt-6 text-sm font-semibold text-blue-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
 ورود به بخش
 </div>
 </NavLink>
);
...
function SystemManagement() {
 return (
 <div
 className="bg-slate-50 min-h-full p-4 sm:p-6 lg:p-8 h-screen"
 dir="rtl"
 >
 ...
 <NavLink
 to="/"
 className="text-sm text-slate-600 hover:text-blue-700 flex items-center gap-2 mb-4"
 >
 <ArrowRightOutlined />
 بازگشت به صفحه اصلی
 </NavLink>
 ...
 از این بخش می‌توانید کاربران، سمت‌ها و دسترسی‌های مختلف سیستم را
 مدیریت کنید.
 </p>
 </header>
