...
const ManagementCard = ({ item }) => (
  ...
  >
    <div>
      <div className="mb-4">
        <div className="w-12 h-12 flex items-center justify-center rounded-lg bg-slate-100 group-hover:bg-sky-100 transition-colors duration-300">
          {item.icon}
        </div>
      </div>
    ...
    <div className="mt-6 text-sm font-semibold text-sky-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
      ورود به بخش
    </div>
  </NavLink>
);
    ...
    >
      <div className="max-w-7xl mx-auto">
        <header className="mb-8">
          <NavLink
            to="/"
            className="text-sm text-slate-600 hover:text-sky-700 flex items-center gap-2 mb-4"
          >
            <ArrowRightOutlined />
            بازگشت به صفحه اصلی
          </NavLink>
