...
const ProductSelectionPanel = (
 ...
 <div>
 <span className={hasAccess ? "text-blue-600 font-semibold" : "text-slate-800"}>
{nodeData.title}
 {hasAccess && <span className="text-xs text-blue-500 mr-2">(قبلاً انتخاب شده)</span>}
 </span>
 </div>
 {hasAccess && (
 <div>
 ...
 <div className="
 [&_.ant-tree-checkbox-checked_.ant-tree-checkbox-inner]:bg-blue-500
 [&_.ant-tree-checkbox-checked_.ant-tree-checkbox-inner]:border-blue-500
 [&_.ant-tree-checkbox-checked]:border-blue-500
 [&_.ant-tree-checkbox-checked::after]:border-blue-500
 [&_.ant-tree-checkbox:not(.ant-tree-checkbox-checked)_]:border-slate-300
 [&_.ant-tree-checkbox:not(.ant-tree-checkbox-checked)_.ant-tree-checkbox-inner]:bg-slate-100
 [&_.ant-tree-checkbox:not(.ant-tree-checkbox-checked)_.ant-tree-checkbox-inner]:border-slate-300
 [&_.ant-tree-checkbox-wrapper:hover_.ant-tree-checkbox-inner]:border-blue-400
 [&_.ant-tree-checkbox:hover_.ant-tree-checkbox-inner]:border-blue-400
 [&_.ant-tree-checkbox-wrapper:hover_.ant-tree-checkbox:not(.ant-tree-checkbox-checked)_.ant-tree-checkbox-inner]:bg-blue-50
 [&_.ant-tree-checkbox:hover:not(.ant-tree-checkbox-checked)_.ant-tree-checkbox-inner]:bg-blue-50">
 <Tree
 checkable
 checkStrictly
 onCheck={handleCheck}
