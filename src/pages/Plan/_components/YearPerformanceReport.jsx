...
//     const year = yearOverride ?? yearInput;
//     setSearchParams((prev) => ({ ...prev, year }));
//     // توجه: اینجا refetch دستی صدا زده نمی‌شود. چون year در query key هر دو
//     // هوک (useProductionPlanList و useYearPercentageOfPerformanceList) در
//     // Plan.jsx حضور دارد، به‌محض تغییر state و رندر مجدد، react-query خودش
//     // به‌صورت خودکار هر دو کوئری (گزارش و جدول) را با سال جدید فچ می‌کند.
//   };
