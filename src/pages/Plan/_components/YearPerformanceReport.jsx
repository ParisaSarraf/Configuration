...
const YearPerformanceReport = ({
 ...
 <span className="inline-flex items-center gap-1.5 align-middle ms-3 rounded-full border border-blue-100 bg-blue-50 px-3 py-1 text-sm font-medium text-slate-500">
